      ...
      <div className="container">
          ...
          <div className="about-box">
            <div className="about-text">
              ...
              <p>Biz bilan taʼlim sayohatingizni boshlash uchun gmail.com yoki +998901427395 raqami orqali biz bilan bogʻlaning!</p>

              <a href='https://t.me/arabtilionline'><BsTelegram color='#0088cc' size={25}/>Telegram</a>    <a href='https://www.youtube.com/@ARABTILIONLINE'><AiFillYoutube color='red' size={25}/>Youtube</a>
            </div>
          </div>
      </div>
    </>
